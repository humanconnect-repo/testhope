...
export default function TransactionProgressModal({
  ...
  const copyAllContent = async () => {
    let allContent = '=== BELLA NAPOLI - LOG ATTIVAZIONE CONTRACT ===\n\n';
    ...
    if (transactionHash) {
      ...
      if (contractAddress) {
        allContent += `Contract: ${contractAddress}\n`;
        allContent += `Contract BSCScan: https://testnet.bscscan.com/address/${contractAddress}\n`;
      }
      allContent += '\n';
    }
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors p-1"
                      title="Copia indirizzo contratto completo"
                    >
                      {copiedItem === 'contract' ? (
                        <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
