...
export default function PredictionPage({ params }: { params: { slug: string } }) {
    ...
    return (prediction: PredictionData | null) => {
      ...
      switch (prediction.status) {
        ...
        case 'in_attesa':
          return {
            type: 'waiting',
            message: 'In attesa del deploy del contratto',
            status: 'Prediction in attesa',
            highlightText: null
          };
  ...
  }, [poolAddress, poolState, prediction]); // Dipende da poolAddress, poolState e prediction
              ...
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                  {(() => {
                    ...
                    if (containerStatus.type === 'waiting') {
                      return <span className="text-yellow-500 font-bold text-2xl">{text}</span>;
                    }
                    return text;
                  })()}
                  ...
                  <div className={`mb-6 p-4 rounded-lg border ${
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        {containerStatus.type !== 'paused' && containerStatus.type !== 'cancelled' && containerStatus.type !== 'closed_waiting' && containerStatus.type !== 'resolved' && containerStatus.type !== 'waiting' && (
