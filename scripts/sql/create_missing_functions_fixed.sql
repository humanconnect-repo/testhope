...
-- 1. Prima elimina le funzioni esistenti se esistono
...
-- 2. Funzione per ottenere le prediction con percentuali calcolate
...
-- 3. Funzione per ottenere le percentuali di una singola prediction
...
-- 4. Funzione per ottenere i top scommettitori di una prediction
...
-- 5. Funzione per ottenere i commenti di una prediction
